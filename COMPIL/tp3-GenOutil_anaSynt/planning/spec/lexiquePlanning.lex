...
{dateCst} { // on a reconnu le mot-clé dateCst
  return creerSymbole("date",TypeSymboles.DATECST);
}
{masterCst} { // on a reconnu le mot-clé masterCst
  return creerSymbole("master",TypeSymboles.MASTERCST);
}
{roomCst} {// on a reconnu le mot-clé roomCst
  return creerSymbole("room",TypeSymboles.ROOMCST);
}

{smallPauseCst} {// on a reconnu le mot-clé  smallPauseCst
  return creerSymbole("petitePause",TypeSymboles.PETITEPAUSE);
}

{bigPauseCst} {// on a reconnu le mot-clé  bigPauseCst
