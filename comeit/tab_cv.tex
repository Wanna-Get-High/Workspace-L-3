...
%     Amara T.
%     & 24/10 % date d'envoi de ton C.V.
%     & % date de recepetion du C.V.
%     & % commentaire que t'envoie positif (sous forme d'itemize voir à la fin)
%     & % commentaire que t'envoie à améliorer	
%     & % date d'envoi de tes coms
%     & % date de reception des coms
%     & % com reçu positif
%     & % com reçu à améliorer 
%     \\\hline % fin d'une ligne de tableau
...
%% les & sont les delimitateurs entrent les lignes colonnes du tableau
%% pour un itemize :
%% \begin{itemize}
%% \item com1
%% \item com2
